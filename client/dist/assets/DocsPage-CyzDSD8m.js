import{x as D,r as l,j as e,o as k,p as C}from"./index-G57A-SeW.js";import{M as I}from"./Markdown-CYqypq6R.js";import{S as E}from"./search-BhITGo_z.js";import{C as O}from"./chevron-right-DJ2UeUVZ.js";const c=["OPS_ADMIN","SENIOR_MANAGER","CAPABILITY_MANAGER"],p=["OPS_ADMIN","SENIOR_MANAGER"],R={"data-sync":p,master:c,exited:c,moved:c,training:c,roles:p,org:p,contribution:p,requests:c,"exit-alerts":c,users:["OPS_ADMIN"],removed:["OPS_ADMIN"],settings:["OPS_ADMIN"],emails:["OPS_ADMIN"],certifications:["OPS_ADMIN"],audit:p,"my-stats":["INSTRUCTOR"]},T={OPS_ADMIN:"guide-ops-admin",SENIOR_MANAGER:"guide-senior-manager",CAPABILITY_MANAGER:"guide-capability-manager",INSTRUCTOR:"guide-instructor"};function N(n){const i=T[n];return S.filter(t=>{if(t.id.startsWith("guide-")&&t.id!==i)return!1;const s=R[t.id];return!(s&&!s.includes(n))})}const S=[{id:"guide-ops-admin",title:"Ops Admin quick start",group:"Your role",body:`# Ops Admin — quick start
...
- **Export CSV** (mirrors the filters).`}],P=new Set(["OPS_ADMIN","SENIOR_MANAGER","CAPABILITY_MANAGER","INSTRUCTOR"]);function q(n){if(!n)return null;const i=n.trim().toUpperCase().replace(/-/g,"_");return P.has(i)?i:null}function B(){var w;const[n]=D(),i=q(n.get("role")),t=l.useMemo(()=>i?N(i):S,[i]),[s,b]=l.useState(((w=t[0])==null?void 0:w.id)||""),[m,M]=l.useState("");l.useEffect(()=>{const a=document.documentElement.style.overflow,r=document.body.style.overflow;return document.documentElement.style.overflow="hidden",document.body.style.overflow="hidden",()=>{document.documentElement.style.overflow=a,document.body.style.overflow=r}},[]),l.useEffect(()=>{var a;t.some(r=>r.id===s)||b(((a=t[0])==null?void 0:a.id)||"")},[t,s]);const h=l.useMemo(()=>{const a=m.trim().toLowerCase();return a?t.filter(r=>(r.title+" "+r.body).toLowerCase().includes(a)):t},[m,t]),A=l.useMemo(()=>{const a=[],r=new Map;for(const o of h)r.has(o.group)||(r.set(o.group,[]),a.push(o.group)),r.get(o.group).push(o);return a.map(o=>({group:o,items:r.get(o)}))},[h]),d=t.find(a=>a.id===s)||t[0],u=d?t.findIndex(a=>a.id===d.id):-1,g=u>0?t[u-1]:null,y=u>=0&&u<t.length-1?t[u+1]:null,f=a=>{var r;b(a),(r=document.getElementById("doc-content-scroll"))==null||r.scrollTo({top:0})};if(!t.length)return e.jsx("div",{className:"flex h-screen items-center justify-center bg-white text-sm text-slate-500",children:"No documentation sections match this role."});const v=i?C[i]||i:null;return e.jsxs("div",{className:"flex h-screen w-full flex-col overflow-hidden bg-white",children:[e.jsxs("header",{className:"flex shrink-0 items-center gap-3 border-b border-slate-200 bg-white px-4 py-3 sm:px-5",children:[e.jsx("span",{className:"flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-brand-600 text-white shadow-sm",children:e.jsx(k,{className:"h-5 w-5"})}),e.jsxs("div",{className:"min-w-0 flex-1",children:[e.jsx("h1",{className:"truncate text-base font-bold leading-tight text-slate-900 sm:text-lg",children:"FacultyOps Documentation"}),e.jsx("p",{className:"truncate text-xs text-slate-500",children:v?`Guide for ${v} — ${t.length} sections`:`Complete reference — ${t.length} sections`})]}),e.jsxs("span",{className:"hidden shrink-0 rounded-full bg-slate-100 px-3 py-1 text-xs font-medium text-slate-500 sm:inline",children:[t.length," sections"]})]}),e.jsxs("div",{className:"flex min-h-0 flex-1 overflow-hidden",children:[e.jsxs("aside",{className:"flex w-64 shrink-0 flex-col overflow-hidden border-r border-slate-200 bg-slate-50/80 sm:w-72",children:[e.jsx("div",{className:"shrink-0 border-b border-slate-200 p-3",children:e.jsxs("div",{className:"relative",children:[e.jsx(E,{className:"pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-400"}),e.jsx("input",{value:m,onChange:a=>M(a.target.value),placeholder:"Search docs…",className:"h-9 w-full rounded-lg border border-slate-200 bg-white pl-9 pr-3 text-sm outline-none transition focus:border-brand-400 focus:ring-2 focus:ring-brand-100"})]})}),e.jsxs("nav",{className:"min-h-0 flex-1 overflow-y-auto overscroll-contain p-2.5",children:[A.map(({group:a,items:r})=>e.jsxs("div",{className:"mb-3",children:[e.jsx("div",{className:"px-2.5 py-1.5 text-[11px] font-semibold uppercase tracking-wider text-slate-400",children:a}),r.map(o=>{const x=s===o.id;return e.jsxs("button",{onClick:()=>f(o.id),className:`group flex w-full items-center gap-2 rounded-lg px-2.5 py-2 text-left text-sm transition ${x?"bg-brand-600 font-medium text-white shadow-sm":"text-slate-600 hover:bg-white hover:text-slate-900"}`,children:[e.jsx("span",{className:`h-1.5 w-1.5 shrink-0 rounded-full ${x?"bg-white":"bg-slate-300 group-hover:bg-brand-400"}`}),e.jsx("span",{className:"truncate",children:o.title})]},o.id)})]},a)),!h.length&&e.jsxs("div",{className:"px-3 py-6 text-center text-sm text-slate-400",children:["No section matches “",m,"”."]})]})]}),e.jsx("section",{id:"doc-content-scroll",className:"min-h-0 flex-1 overflow-y-auto overscroll-contain bg-white",children:d&&e.jsxs("div",{className:"mx-auto max-w-5xl px-5 py-6 sm:px-8 lg:px-12",children:[e.jsxs("div",{className:"mb-5 flex items-center gap-1.5 text-xs font-medium text-slate-400",children:[e.jsx("span",{children:d.group}),e.jsx(O,{className:"h-3.5 w-3.5"}),e.jsx("span",{className:"text-slate-600",children:d.title})]}),e.jsx(I,{source:d.body}),e.jsxs("div",{className:"mt-12 grid gap-3 border-t border-slate-100 pt-6 sm:grid-cols-2",children:[g?e.jsxs("button",{onClick:()=>f(g.id),className:"flex flex-col items-start rounded-xl border border-slate-200 px-4 py-3 text-left transition hover:border-brand-300 hover:bg-brand-50/40",children:[e.jsx("span",{className:"text-[11px] font-semibold uppercase tracking-wide text-slate-400",children:"← Previous"}),e.jsx("span",{className:"mt-0.5 text-sm font-medium text-slate-800",children:g.title})]}):e.jsx("span",{}),y?e.jsxs("button",{onClick:()=>f(y.id),className:"flex flex-col items-end rounded-xl border border-slate-200 px-4 py-3 text-right transition hover:border-brand-300 hover:bg-brand-50/40 sm:col-start-2",children:[e.jsx("span",{className:"text-[11px] font-semibold uppercase tracking-wide text-slate-400",children:"Next →"}),e.jsx("span",{className:"mt-0.5 text-sm font-medium text-slate-800",children:y.title})]}):e.jsx("span",{})]})]})})]})]})}export{B as default};
