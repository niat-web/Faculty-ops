import{r as l,j as e,o as f}from"./index-B11IJ_-b.js";import{M as v}from"./Markdown-s0YTI4yP.js";import{S as w}from"./search-CasS-BYI.js";import{C as x}from"./chevron-right-r_ytxTeY.js";const i=[{id:"overview",title:"Overview",group:"Start here",body:`# FacultyOps — Overview
...
- **Export CSV** (mirrors the filters).`}];function k(){const[h,g]=l.useState(i[0].id),[n,y]=l.useState(""),d=l.useMemo(()=>{const t=n.trim().toLowerCase();return t?i.filter(r=>(r.title+" "+r.body).toLowerCase().includes(t)):i},[n]),b=l.useMemo(()=>{const t=[],r=new Map;for(const a of d)r.has(a.group)||(r.set(a.group,[]),t.push(a.group)),r.get(a.group).push(a);return t.map(a=>({group:a,items:r.get(a)}))},[d]),o=i.find(t=>t.id===h)||i[0],s=i.findIndex(t=>t.id===o.id),c=s>0?i[s-1]:null,p=s<i.length-1?i[s+1]:null,u=t=>{var r;g(t),(r=document.getElementById("doc-scroll"))==null||r.scrollTo({top:0})};return e.jsxs("div",{className:"flex h-screen w-full flex-col overflow-hidden bg-white",children:[e.jsxs("header",{className:"flex shrink-0 items-center gap-3 border-b border-slate-200 bg-white px-5 py-3.5 sm:px-6",children:[e.jsx("span",{className:"flex h-9 w-9 items-center justify-center rounded-xl bg-brand-600 text-white shadow-sm",children:e.jsx(f,{className:"h-5 w-5"})}),e.jsxs("div",{className:"min-w-0",children:[e.jsx("h1",{className:"truncate text-lg font-bold leading-tight text-slate-900",children:"FacultyOps Documentation"}),e.jsx("p",{className:"truncate text-xs text-slate-500",children:"How every page works, each field, and where the data comes from."})]}),e.jsxs("span",{className:"ml-auto hidden rounded-full bg-slate-100 px-3 py-1 text-xs font-medium text-slate-500 sm:inline",children:[i.length," sections"]})]}),e.jsxs("div",{className:"flex min-h-0 flex-1 overflow-hidden",children:[e.jsxs("aside",{className:"flex w-72 shrink-0 flex-col border-r border-slate-200 bg-slate-50/60",children:[e.jsx("div",{className:"shrink-0 border-b border-slate-200 p-3",children:e.jsxs("div",{className:"relative",children:[e.jsx(w,{className:"pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-400"}),e.jsx("input",{value:n,onChange:t=>y(t.target.value),placeholder:"Search docs…",className:"h-9 w-full rounded-lg border border-slate-200 bg-white pl-9 pr-3 text-sm outline-none transition focus:border-brand-400 focus:ring-2 focus:ring-brand-100"})]})}),e.jsxs("nav",{className:"min-h-0 flex-1 overflow-y-auto p-2.5",children:[b.map(({group:t,items:r})=>e.jsxs("div",{className:"mb-3",children:[e.jsx("div",{className:"px-2.5 py-1.5 text-[11px] font-semibold uppercase tracking-wider text-slate-400",children:t}),r.map(a=>{const m=h===a.id;return e.jsxs("button",{onClick:()=>u(a.id),className:`group flex w-full items-center gap-2 rounded-lg px-2.5 py-2 text-left text-sm transition ${m?"bg-brand-600 font-medium text-white shadow-sm":"text-slate-600 hover:bg-white hover:text-slate-900"}`,children:[e.jsx("span",{className:`h-1.5 w-1.5 shrink-0 rounded-full ${m?"bg-white":"bg-slate-300 group-hover:bg-brand-400"}`}),e.jsx("span",{className:"truncate",children:a.title})]},a.id)})]},t)),!d.length&&e.jsxs("div",{className:"px-3 py-6 text-center text-sm text-slate-400",children:["No section matches “",n,"”."]})]})]}),e.jsx("section",{id:"doc-scroll",className:"min-h-0 flex-1 overflow-y-auto bg-white",children:e.jsxs("div",{className:"mx-auto max-w-5xl px-6 py-8 sm:px-10 lg:px-14",children:[e.jsxs("div",{className:"mb-5 flex items-center gap-1.5 text-xs font-medium text-slate-400",children:[e.jsx("span",{children:o.group}),e.jsx(x,{className:"h-3.5 w-3.5"}),e.jsx("span",{className:"text-slate-600",children:o.title})]}),e.jsx(v,{source:o.body}),e.jsxs("div",{className:"mt-12 grid gap-3 border-t border-slate-100 pt-6 sm:grid-cols-2",children:[c?e.jsxs("button",{onClick:()=>u(c.id),className:"flex flex-col items-start rounded-xl border border-slate-200 px-4 py-3 text-left transition hover:border-brand-300 hover:bg-brand-50/40",children:[e.jsx("span",{className:"text-[11px] font-semibold uppercase tracking-wide text-slate-400",children:"← Previous"}),e.jsx("span",{className:"mt-0.5 text-sm font-medium text-slate-800",children:c.title})]}):e.jsx("span",{}),p?e.jsxs("button",{onClick:()=>u(p.id),className:"flex flex-col items-end rounded-xl border border-slate-200 px-4 py-3 text-right transition hover:border-brand-300 hover:bg-brand-50/40 sm:col-start-2",children:[e.jsx("span",{className:"text-[11px] font-semibold uppercase tracking-wide text-slate-400",children:"Next →"}),e.jsx("span",{className:"mt-0.5 text-sm font-medium text-slate-800",children:p.title})]}):e.jsx("span",{})]})]})})]})]})}export{k as default};
