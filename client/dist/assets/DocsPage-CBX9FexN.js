...
- **Export CSV** (mirrors the filters).`}],D=["OPS_ADMIN","SENIOR_MANAGER","CAPABILITY_MANAGER","INSTRUCTOR"];function F(o){if(!o)return null;const r=o.trim().toUpperCase().replace(/-/g,"_");return D.includes(r)?r:null}function x(o,r){var t;return o==="CAPABILITY_MANAGER"&&r.some(s=>s.id==="cm-intro-video")?"cm-intro-video":((t=r[0])==null?void 0:t.id)||""}function U(){return e.jsx("div",{className:"flex h-screen flex-col items-center justify-center bg-slate-50 px-4",children:e.jsxs("div",{className:"w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 shadow-sm",children:[e.jsxs("div",{className:"mb-6",children:[e.jsx(M,{logoSize:36,dark:!1}),e.jsx("p",{className:"mt-3 text-sm font-medium text-slate-700",children:"Documentation"}),e.jsx("p",{className:"text-sm text-slate-500",children:"Choose your role to open the right guide"})]}),e.jsx("div",{className:"space-y-2",children:D.map(o=>e.jsxs("a",{href:`/docs?role=${encodeURIComponent(o)}`,target:"_blank",rel:"noopener noreferrer",className:"flex items-center justify-between rounded-xl border border-slate-200 px-4 py-3 text-sm font-medium text-slate-800 transition hover:border-brand-300 hover:bg-brand-50/50",children:[S[o]||o,e.jsx(A,{className:"h-4 w-4 text-slate-400"})]},o))})]})})}function B({fileId:o}){return e.jsx("div",{className:"mb-6 w-full overflow-hidden rounded-xl border border-slate-200 bg-slate-900 shadow-sm",children:e.jsx("iframe",{src:`https://drive.google.com/file/d/${o}/preview`,title:"Capability Manager intro video",className:"aspect-video w-full border-0",allow:"autoplay; encrypted-media",allowFullScreen:!0})})}function G(){const[o]=E(),r=F(o.get("role")),t=d.useMemo(()=>r?q(r):[],[r]),[s,h]=d.useState(""),[m,k]=d.useState("");d.useEffect(()=>{r&&t.length&&h(x(r,t))},[r,t]),d.useEffect(()=>{const a=document.documentElement.style.overflow,i=document.body.style.overflow;return document.documentElement.style.overflow="hidden",document.body.style.overflow="hidden",()=>{document.documentElement.style.overflow=a,document.body.style.overflow=i}},[]),d.useEffect(()=>{t.length&&!t.some(a=>a.id===s)&&h(x(r,t))},[t,s,r]);const g=d.useMemo(()=>{const a=m.trim().toLowerCase();return a?t.filter(i=>(i.title+" "+i.body).toLowerCase().includes(a)):t},[m,t]),I=d.useMemo(()=>{const a=[],i=new Map;for(const n of g)i.has(n.group)||(i.set(n.group,[]),a.push(n.group)),i.get(n.group).push(n);return a.map(n=>({group:n,items:i.get(n)}))},[g]);if(!r)return e.jsx(U,{});const l=t.find(a=>a.id===s)||t[0],u=l?t.findIndex(a=>a.id===l.id):-1,y=u>0?t[u-1]:null,f=u>=0&&u<t.length-1?t[u+1]:null,b=a=>{var i;h(a),(i=document.getElementById("doc-content-scroll"))==null||i.scrollTo({top:0})};if(!t.length)return e.jsx("div",{className:"flex h-screen items-center justify-center bg-white text-sm text-slate-500",children:"No documentation sections match this role."});const w=S[r]||r;return e.jsxs("div",{className:"flex h-screen w-full flex-col overflow-hidden bg-white",children:[e.jsxs("header",{className:"flex shrink-0 items-center gap-4 border-b border-slate-200 bg-white px-4 py-3 sm:px-5",children:[e.jsx(M,{logoSize:36,dark:!1,className:"shrink-0"}),e.jsxs("div",{className:"min-w-0 flex-1 border-l border-slate-200 pl-4",children:[e.jsx("h1",{className:"truncate text-sm font-semibold leading-tight text-slate-900 sm:text-base",children:"Documentation"}),e.jsxs("p",{className:"truncate text-xs text-slate-500",children:["Guide for ",w," — ",t.length," sections"]})]}),e.jsx("span",{className:"hidden shrink-0 rounded-full bg-brand-50 px-3 py-1 text-xs font-medium text-brand-700 ring-1 ring-brand-200 sm:inline",children:w})]}),e.jsxs("div",{className:"flex min-h-0 flex-1 overflow-hidden",children:[e.jsxs("aside",{className:"flex w-64 shrink-0 flex-col overflow-hidden border-r border-slate-200 bg-slate-50/80 sm:w-72",children:[e.jsx("div",{className:"shrink-0 border-b border-slate-200 p-3",children:e.jsxs("div",{className:"relative",children:[e.jsx(O,{className:"pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-400"}),e.jsx("input",{value:m,onChange:a=>k(a.target.value),placeholder:"Search docs…",className:"h-9 w-full rounded-lg border border-slate-200 bg-white pl-9 pr-3 text-sm outline-none transition focus:border-brand-400 focus:ring-2 focus:ring-brand-100"})]})}),e.jsxs("nav",{className:"min-h-0 flex-1 overflow-y-auto overscroll-contain p-2.5",children:[I.map(({group:a,items:i})=>e.jsxs("div",{className:"mb-3",children:[e.jsx("div",{className:"px-2.5 py-1.5 text-[11px] font-semibold uppercase tracking-wider text-slate-400",children:a}),i.map(n=>{const v=s===n.id;return e.jsxs("button",{onClick:()=>b(n.id),className:`group flex w-full items-center gap-2 rounded-lg px-2.5 py-2 text-left text-sm transition ${v?"bg-brand-600 font-medium text-white shadow-sm":"text-slate-600 hover:bg-white hover:text-slate-900"}`,children:[n.videoId?e.jsx(N,{className:`h-3.5 w-3.5 shrink-0 ${v?"text-white":"text-brand-500"}`,strokeWidth:1.75}):e.jsx("span",{className:`h-1.5 w-1.5 shrink-0 rounded-full ${v?"bg-white":"bg-slate-300 group-hover:bg-brand-400"}`}),e.jsx("span",{className:"truncate",children:n.title})]},n.id)})]},a)),!g.length&&e.jsxs("div",{className:"px-3 py-6 text-center text-sm text-slate-400",children:["No section matches “",m,"”."]})]})]}),e.jsx("section",{id:"doc-content-scroll",className:"min-h-0 flex-1 overflow-y-auto overscroll-contain bg-white",children:l&&e.jsxs("div",{className:l.videoId?"w-full px-5 py-6 sm:px-8 lg:px-10":"mx-auto max-w-5xl px-5 py-6 sm:px-8 lg:px-12",children:[e.jsxs("div",{className:"mb-5 flex items-center gap-1.5 text-xs font-medium text-slate-400",children:[e.jsx("span",{children:l.group}),e.jsx(A,{className:"h-3.5 w-3.5"}),e.jsx("span",{className:"text-slate-600",children:l.title})]}),l.videoId&&e.jsx(B,{fileId:l.videoId}),e.jsx(R,{source:l.body}),e.jsxs("div",{className:"mt-12 grid gap-3 border-t border-slate-100 pt-6 sm:grid-cols-2",children:[y?e.jsxs("button",{onClick:()=>b(y.id),className:"flex flex-col items-start rounded-xl border border-slate-200 px-4 py-3 text-left transition hover:border-brand-300 hover:bg-brand-50/40",children:[e.jsx("span",{className:"text-[11px] font-semibold uppercase tracking-wide text-slate-400",children:"← Previous"}),e.jsx("span",{className:"mt-0.5 text-sm font-medium text-slate-800",children:y.title})]}):e.jsx("span",{}),f?e.jsxs("button",{onClick:()=>b(f.id),className:"flex flex-col items-end rounded-xl border border-slate-200 px-4 py-3 text-right transition hover:border-brand-300 hover:bg-brand-50/40 sm:col-start-2",children:[e.jsx("span",{className:"text-[11px] font-semibold uppercase tracking-wide text-slate-400",children:"Next →"}),e.jsx("span",{className:"mt-0.5 text-sm font-medium text-slate-800",children:f.title})]}):e.jsx("span",{})]})]})})]})]})}export{G as default};
