      ...
      <div className="card p-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            ...
            <input className="input" type="number" min={6} max={64} value={s.passwordMinLength} onChange={num("passwordMinLength", 6, 64)} />
          ...
          <div className="flex items-end">
            <label className="flex w-full items-center justify-between gap-4 rounded-lg border border-slate-200 px-4 py-2.5">
              ...
              <button
                type="button" role="switch" aria-checked={s.requireComplexity}
                onClick={() => setS({ ...s, requireComplexity: !s.requireComplexity })}
                className={`relative inline-flex h-6 w-11 shrink-0 items-center rounded-full transition ${s.requireComplexity ? "bg-brand-600" : "bg-slate-300"}`}>
      ...
      <div className="card p-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            ...
            <input className="input" type="number" min={3} max={50} value={s.maxLoginAttempts} onChange={num("maxLoginAttempts", 3, 50)} />
          ...
          <div>
            ...
            <input className="input" type="number" min={1} max={1440} value={s.lockoutMinutes} onChange={num("lockoutMinutes", 1, 1440)} />
