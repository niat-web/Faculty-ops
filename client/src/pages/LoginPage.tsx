      ...
      <div className="flex min-h-screen items-center justify-center px-6 py-24">
        <div className="w-full max-w-sm">
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
            ...
            {googleOn && !needs2fa && (
              <>
                <a href={`${API_BASE}/api/auth/google`} className="btn btn-outline mt-6 w-full">
            ...
            <p className="mt-4 text-center text-sm text-slate-500"><Link to="/reset" className="font-semibold text-brand-600 hover:underline">Forgot / set password</Link></p>
          </div>
        </div>
      </div>
    </div>
